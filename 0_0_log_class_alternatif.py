...
"utiliser avec un terminal ulog2csv <nom_du_log> -o ./donnees"
"puis run le script "

print("############################################")
print("!! Indexes may vary if plane log or sim log !!")
print("############################################")
...
class Log():
    ...
    def rename_csvs(self,csv_path=""):
        self.csv_path=csv_path
        for file in os.listdir(csv_path):
                if "actuator_outputs_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'actuators.csv'))
                if "battery_status_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'battery.csv'))
                if "vehicle_local_position_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'local_pos.csv'))
                if "gps_position_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'gps.csv'))
                if "actuator_controls_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'controls.csv'))
                ...
                if "angular_velocity_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'angular_vel.csv'))

                if "vehicle_attitude_groundtruth_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'attitude.csv'))
                elif "vehicle_attitude_0" in file:
                    os.system('cp '+os.path.join(self.csv_path,file)+' '+os.path.join(self.csv_path, 'attitude.csv'))

    def import_log(self,csv_path=""):
        dpath=csv_path
        ...
        self.DATA=DATA
        DATA.to_csv(os.path.join(csv_path,'DATA.csv'))
    ...
    def data_to_dic(self,csv_path=""):
        ...
        with open(os.path.join(csv_path,"log_real.csv"),'a',newline='') as log:
...
l=Log()
l.rename_csvs("./donnees")
l.import_log("./donnees")
l.data_to_dic("./donnees")
