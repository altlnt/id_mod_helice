...
def main_func(x):
    ...
    t0=time.time()
      ...
      def Generate_equation():
        ...
        delta_0 = Symbol('delta_0',real=True)                 # Angle de controle des ailerons
        ...
        omega=symbols('\omega,C_t',real=True)                                      # vitesse de rotation des moteurs
